...
class LinkedList:
    ...
    def append(self, value):
        new_node = Node(value)
        #si la cabeza esta vacia significa que no existe nada en ella por lo que el nodo que creamos pasa a ser la cabeza
        if(self.head == None):
            self.head = new_node
            self.tail = new_node
        else:
    ...
    def generarTablero(self, filas, columnas):
        ...
        #creamos una lista enlazada de listas enlazadas en la que ellas representaran las filas de nuestra matriz y el contenido de ellas las columnas
    ...
    def cuadrarNodos(self, current, fila = 0):
        #si estamos parados en la primera lista enlazada entonces significa que todos esos nodos solo pueden apuntar para abajo
        if fila == 0:
        ...
        #si nuestro auxiliar fila es igual a la cantidad de filas significa que estamos parados en la ultima fila lo cual significa que los nodos de esa lista enlazada deben apuntar para arriba
        ...
        #y si no es ninguno de los anteriores significa que los nodos de la lista enlazada deben apuntar para arriba y abajo
        else:
            #nodos los cuales vamos a cuadrar
            currentLinkedList = current.value.head
            siguienteLinkedList = current.right.value.head
